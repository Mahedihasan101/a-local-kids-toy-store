...
import img1 from '../assets/technology-abstract-background-with-particle-lines.jpg'
        ...
        <Helmet>
         ...
         <div className="hero  min-h-screen" style={{ backgroundImage: `url(${img1})` }}>
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl" style={{ backgroundImage: `url(${img2})` }}>
                    <form onSubmit={handleRegister} className="card-body" >
                        <fieldset className="fieldset relative">
                            {/* name */}
                            <label className="label text-white ">Name</label>
                            <input name="name" type="text" className="input w-full rounded-3xl" placeholder="Name" />
                            {/* photo url */}
                            <label className="label text-white">Photo URl</label>
                            <input name="photo" type="text" className="input w-full rounded-3xl" placeholder="Photo URl" />
                            {/* Email */}
                            ...
                            <button onClick={handleGoogleSignIn} className="btn bg-white text-black border-[#e5e5e5] rounded-3xl">
                            ...
                            <p className='font-semibold text-center text-white'>Allready Have An Account ? <Link className='text-red-600' to="/login">Login</Link></p>
                        </fieldset>
                    </form>
                </div>
